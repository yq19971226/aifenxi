...
const CONFIG_GROUPS: ConfigGroup[] = [
  {
    ...
    items: [
      ...
      { key: "nowpayments_api_key", isSecret: true, category: "payment" },
      { key: "nowpayments_ipn_secret", isSecret: true, category: "payment" },
      { key: "nowpayments_ipn_callback_url", isSecret: false, category: "payment" },
