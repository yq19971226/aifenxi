...
export function NotificationDrawer() {
  const t = useTranslations("announcements"); // Or use hardcoded defaults 
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between gap-3 mb-2">
                        ...
                        {item.last_event === "confirmed" && (
                          <div className="shrink-0 flex items-center justify-center bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest gap-1">
                      ...
                      <h3 className={cn(
                        "text-[15px] font-bold tracking-tight mb-1.5 leading-snug", 
