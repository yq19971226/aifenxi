...
export function AuthLayout({ children, variant = "login" }: { children: React.ReactNode; variant?: "login" | "register" }) {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-[45%_55%] bg-background bg-grid text-white selection:bg-[#00E5FF]/30">
      {/* Left: Form Area */}
      <div className="relative flex flex-col justify-center px-4 sm:px-12 lg:px-20 py-12 border-r border-white/[0.04] bg-background/80 backdrop-blur-3xl z-10 transition-all duration-500 overflow-y-auto overflow-x-hidden">
        {/* Spotlight Effect for the form area */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-96 bg-[#00E5FF]/15 blur-[120px] pointer-events-none mix-blend-screen" />
        <div className="absolute bottom-0 left-0 w-full max-w-lg h-96 bg-[#F500FF]/10 blur-[120px] pointer-events-none mix-blend-screen" />
        ...
        <div className="w-full max-w-sm mx-auto relative z-20 my-auto py-8">
          <div className="mb-10 text-center lg:text-left">
            <LogoMark className="h-10 w-10 text-[#00E5FF] mb-6 mx-auto lg:mx-0 drop-shadow-[0_0_20px_rgba(0,229,255,0.6)]" />
